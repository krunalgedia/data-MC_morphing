...
parser = OptionParser(option_list=[
    ...
    make_option("--inp-file",type='string',dest='inp_file',default='t_dataset_sig_test_plots_NN.h5'),
...
with open('/mnt/t3nfs01/data01/shome/krgedia/Workspace/lxplus/qreg_pt_norm/config_2016_updated_MC_uncorr.json') as fin:
