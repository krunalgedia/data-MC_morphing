...
h5_dir = '/mnt/t3nfs01/data01/shome/krgedia/Workspace/lxplus/qreg_pt_norm/t_r_dataset_sig_train'

data =  pd.read_hdf(h5_dir+'.h5', 'hdf')
...
#    jet_rescale_corr = df.loc[i,'Jet_rawEnergy_corr']/jet_vector_corr.E()
